...
<!--[if (gte IE 9)|!(IE)]><!--><html xmlns="http://www.w3.org/1999/xhtml" class=""> <!--<![endif]-->
	<head>
		...
		<title>Lista e te drejtave</title>
						...
						<table class="table table-hover">
							<?php
								...
								<tr>
									...
									<td class="col-md-2"><a href="actions.php?id=<?php echo $id;?>" type="button" class="btn btn-info btn-xs" ><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;<a href="actions.php?a=delete&id=<?php echo $id;?>" type="button" class="btn btn-danger btn-xs" ><span class="glyphicon glyphicon-trash"></span></a></td>
								</tr>
								<?php	
