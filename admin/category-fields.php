<?php
	...
	if(isset($_REQUEST["id"])&&$_REQUEST["id"]!=0)
	{
		...
		$arrfields = $category_fields->get_by_id_category($id);
		// Denisi
	...
	if(isset($_REQUEST["fielddele"])&&$_REQUEST["fielddele"]!=0)
	{
		...
		$cat_field->Delete();
		/**********/
		header("Location:category-fields.php?id=".$_REQUEST["id"]);die();
		// Denisi
		//$arrfields = $category_fields->get_by_id_category_field($id);
	}
			...
			<div class="row">
				<div class="panel panel-default widget">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-md-6">
								<select class="form-control" name="c" onchange="window.location='category-fields.php?id='+this.value">
									<option value='0' >Zgjidh Kategorine</option>
									<?php
										foreach($arr as $kategori)
										{
											$selected = '';
											if($kategori->id_category == $id)
							...
							<div class="col-md-6">
								<?php
									if( $id != 0 )
									{
										...
										echo  "<a href='category-field-add.php?id=".$id."' class='btn btn-success' role='button'>".
								...
								<tbody>
									<?php
										...
										<tr>
											...
											<td style="width: 90px;"><a href='category-field-update.php?field=<?php echo $field->id_category_field; ?>'
												class='btn btn-warning btn-xs' role='button'>
												<span class='glyphicon glyphicon-edit'></span> Modifiko </a>
											</td>
											<td style="width: 90px;"><a href='category-fields.php?fielddele=<?php echo $field->id_category_field; ?>
												&id=<?php echo $id; ?>'
