<?php
	...
	if($id){
		...
		if(isset($_REQUEST["a"]) && $_REQUEST["a"]=="delete")
		{
			...
			$post->Delete();		
			header("Location:customlist.php&t=".$post_type);
			die();
		}
	}
	if($_POST){
		...
		header("Location:customedit.php?t=".$post_type."&id=".$post->id_post);die();
	}
		...
		<div class="container">
			<form method='post' action='' role="form" class="" enctype="multipart/form-data">
				...
				<div class="form-group col-md-12">
					...
					<a href="customedit.php?t=<?php echo $post_type;?>" class="btn btn-info">Krijo tjeter (<?php echo $post_type;?>)</a>
					<a href="customlist.php?t=<?php echo $post_type;?>" class="btn btn-info">Kthehu te lista</a>
				</div>
				<div class="col-md-9">
				...
				<div class="col-md-3">
					...
					<div class="form-group">
						...
						<select class="form-control" id="parent" name="parent">
							...
							<?php
								$posts = $post->Find("(post_type='".$post_type."' or post_type in ('gallery','slider')) order by post_order");
								foreach($posts as $p){
									$selected ="";
