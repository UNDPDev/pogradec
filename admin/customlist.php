...
<!--[if (gte IE 9)|!(IE)]><!--><html xmlns="http://www.w3.org/1999/xhtml" class=""> <!--<![endif]-->
	...
	<body>
		...
		<div id="main" class="container">
			<div class="row">
				<div class="col-md-12"><a href="customedit.php?t=<?php echo $post_type;?>" class="btn btn-primary btn-success" role="button">Shto nje <?php echo $post_type;?></a></div>
			</div>
			<div class="panel panel-default">
				...
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-md-3">
							<select class="form-control" name="c" onchange="window.location='customlist.php?t=<?php echo $post_type;?>&c='+this.value">
				...
				<table class="table table-hover">
					<?php
						$posts = $post->Find(" (id_post in (select id_post from web_termrel where id_term='".$c."')  or '0'='".$c."') and post_type='".$post_type."' and (title_al like '%".$q."%' or title_en like '%".$q."%') order by id_post desc limit ".($s*20).",20");
						...
						<tr>
							...
							<td class="col-xs-6"><?php echo $post->title_al;?> <br/><?php echo $post->title_en;?><br/><span class="small"><a href="customedit.php?t=<?php echo $post_type;?>&id=<?php echo $id;?>" class="">Modifiko</a></span>&nbsp;|&nbsp;<span class="small"><a href="customedit.php?id=<?php echo $id;?>&a=delete&t=<?php echo $post_type;?>" class="text-danger">Fshi</a></span></td>
							<td class="col-xs-4">
								<?php $termrels = $termrel->get_by_id_post($id); 
