<?php
	...
	$post_type="page";if(isset($_REQUEST["t"])) $post_type = addslashes($_REQUEST["t"]);
...
<!--[if (gte IE 9)|!(IE)]><!--><html xmlns="http://www.w3.org/1999/xhtml" class=""> <!--<![endif]-->
	<head>
		...
		<meta name="description" content="Faqe List" />
	...
	<body>
		...
		<div id="main" class="container">
			<div class="row">
				<div class="col-md-12"><a href="pageedit.php" class="btn btn-primary btn-info" role="button"><span class="glyphicon glyphicon-plus"></span> Shto nje Faqe</a></div>
			</div>
			<div class="row">
				<div class="panel panel-default widget">
					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-md-3">
								<select class="form-control" name="c" onchange="window.location='pagelist.php?c='+this.value">
									<option value='0' >Zgjidh Kategorine</option>
									<?php							
										$terms = $term->Find("term_type='category' and id_term in (select distinct id_term from web_termrel wtr inner join web_post p on wtr.id_post=p.id_post where p.post_type='page')  order by term_parent");
										foreach($terms as $t){
											$selected ="";
					...
					<div class="panel-body">
						<ul class="list-group">
							<?php
								$sql="post_type='page' and (title_al like '%".$q."%' or title_en like '%".$q."%') ";
								if($c) $sql.=" and id_post in (select id_post from web_termrel where id_term='".$c."' or '0'='".$c."') ";
								$sql.="order by id_post desc limit ".($s*20).",20";
								$posts = $post->Find($sql);
								...
								<li class="list-group-item">
									<div class="row">
										...
										<div class="col-xs-10 col-md-11">
											<div>
												<a href="pageedit.php?id=<?php echo $id;?>">
											...
											<div class="action">
												<a href="pageedit.php?id=<?php echo $id;?>" type="button" class="btn btn-primary btn-xs" title="Edit">
													<span class="glyphicon glyphicon-pencil"></span>
												</a>
												<a type="button" href="pageedit.php?id=<?php echo $id;?>&a=delete&t=<?php echo $post_type;?>" class="btn btn-danger btn-xs" title="Delete">
