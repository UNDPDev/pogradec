<?php
	...
	$post->post_image="http://placehold.it/800x300.png";
	if($id){
	...
	if($_POST){
		...
		/**********/
		header("Location:postedit.php?id=".$id);die();
	}
		...
		<div class="container">
			<form method='post' action='' role="form" class="" enctype="multipart/form-data">
				...
				<div class="form-group col-md-12">
					...
					<a href="postedit.php" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span> Krijo tjeter</a>
