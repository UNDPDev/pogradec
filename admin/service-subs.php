...
>>>>>>> origin/master
											...
											<input type="hidden" name="kategoria" value="'.$sub_cat->id_category.'"/>
											<input type="hidden" name="tip" value="shtim"/>
											<p><input type="text" class="typeahead form-control" autocomplete="off" name="name'.$sub_cat->id_category.'" id="name'.$sub_cat->id_category.'"
											spellcheck="false" value="" placeholder="Emri i produktit, psh Dhome Teke, Tave Dheu"/>
											</p><br/>
											...
											';
											$fields = $category_field->Find(" id_category='".$sub_cat->id_category."'  order by field_order, field_type");
											foreach($fields as $field)
											{
